...
int main() {
    ...
    puts("Enter the coordinates of the point: ");
    if (!(cin >> x0 >> y0)) { puts("Invalid Input!\n"); return 1; }


    puts("Enter the coordinates of Vertex 1: ");
    if (!(cin >> x1 >> y1)) {
        puts("Invalid Input!\n"); return 1;

    }

    puts("Enter the coordinates of Vertex 2: ");
    if (!(cin >> x2 >> y2)) {
        puts("Invalid Input!\n"); return 1;

    }

    puts("Enter the coordinates of Vertex 3: ");
    if (!(cin >> x3 >> y3)) {
        puts("Invalid Input!\n"); return 1;
    ...
    if (fabs(area0 - (area1 + area2 + area3)) < EPSILON) {
        puts("The point is inside the triangle!\n");

    } else {
        puts("The point is outside the triangle!\n");
